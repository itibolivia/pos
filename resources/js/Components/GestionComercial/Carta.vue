<template>
    <div class="row justify-content-center">
                  ...
                  <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <table v-show="cartas">
                                  ...
                                  <tbody>
                                      <tr v-for="(carta, doc) in cartas" :key="doc">
                                          <td>{{ carta.adjunto }}</td>
                                          <td>
                                          ...
                                          <td>
                                              <button class="btn btn-sm btn-danger" @click="deleted(carta)">
                                              <!--:disabled="venta.carta != null"-->
                      ...
                      <form @submit.prevent="submit">
                          ...
                          <div class="mb-0">
                              <div class="d-flex justify-content-end align-items-baseline">
                                  ...
                                  :disabled="cartas.length === 0 || form.processing"> <!--:disabled="venta.carta != null || "-->
          ...
          <Cartas v-if="showModal" :form="formArchivo" @adjuntar="adjuntar" @closeModal="closeModal" />
  
  </template>
  
  <script>
  import BreezeButton from '@/Components/Button.vue'
  import Cartas from '@/Components/GestionModals/Cartas.vue'
  ...
  export default {
      ...
      methods: {
          ...
          adjuntar(form) {
              Inertia.post(this.route('cartas.store'), form, {
                  onFinish: () => {
                      this.closeModal();
                      Swal.fire({
                          position: 'top-end',
          ...
          deleted(documento) {
              ...
              swalWithBootstrapButtons.fire({
                  ...
                  if(result.isConfirmed){
                      this.formArchivo.delete(route('cartas.destroy',documento));
                      Swal.fire({
                          position: 'top-end',
                          icon: 'success',
                          showConfirmButton: false,
          ...
          submit() {
              this.form.post(this.route('carta'), this.form, {
              onFinish: () => {
                  Swal.fire({
                          position: 'top-end',
                          icon: 'success',
